##### The code below generates (theta,data) from the Exponential distribution with scale 0.30, ###
...
#### All the data from different runs of this code are combined separately as all_030_data.csv #####
...
for k in tqdm(range(sub_iter)):
    if k % 50 == 0:
        all_regret.to_csv('all_regret_030_number%g.csv' % rand_number, index=False);
