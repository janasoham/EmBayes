...
df_temp = df[["call_fails", "subsc_len", "eb_call_fails", "eb_subsc_len", "churn"]]
...
for count in tqdm(range(total_count-1)):
    ...
    for rand in range(repeat):
        ...
        eb_X_train = df_temp_train[["eb_call_fails", "eb_subsc_len"]]
        eb_X_test = df_temp_test[["eb_call_fails", "eb_subsc_len"]]


        # Define the independent variables (features)
        X_train = df_temp_train[["call_fails", "subsc_len"]]  # Replace with your actual feature columns
        X_test = df_temp_test[["call_fails", "subsc_len"]]  # Replace with your actual feature columns
