...
plot_title="Season 2018 vs Season 2019: Center";

(PX, gpast, gfut) = hockey_data_position(file1, file2, "center");
...
fg = plt.figure(num=35,figsize=(7,5));
plt.clf();
...
plt.savefig("pred_plot_real_w_robbins_center.png");
