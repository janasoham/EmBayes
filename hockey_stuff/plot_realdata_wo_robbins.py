...
plot_title="Season 2018 vs Season 2019";


(PX, gpast, gfut) = hockey_data(file1, file2);
...
print()
print("Prediction errors : rmse_Hellinger=%g, rmse_NPMLE=%g, mse_Chisquare=%g"
      % (rmse_sqH, rmse_npmle, rmse_chisq));
print()
print("Prediction errors absolute: Hellinger=%g, NPMLE=%g, Chisquare=%g"
      % (l1_sqH, l1_npmle, l1_chisq));
print()

fg = plt.figure(num=55,figsize=(7,5));
plt.clf();
...
plt.savefig("pred_plot_real_wo_robbins.png");
plt.pause(1);
